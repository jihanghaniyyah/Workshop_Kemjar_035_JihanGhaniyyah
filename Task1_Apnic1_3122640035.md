...
Komunikasi internet di Indonesia berkembang pesat dan telah mengubah Sebagian besar pola kehidupan bermasyarakat. Meningkatnya jumlah pengakses layanan internet membuat keberadaan World Wide Web (WWW) menjadi sangat penting. WWW hadir sebagai media perantara untuk menyajikan layanan hypermedia [4]. Agar layanan tersebut dapat dikirimkan, diperlukan suatu protokol pengiriman data yang disebut Hypertext Transfer Protocol atau biasa disebut HTTP [5]. Oleh karenanya, pemberdayaan web server untuk melayani request berbasis HTTP menjadi sebuah kebutuhan.<br>
